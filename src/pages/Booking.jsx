...
import Img1 from "../assets/bookingImgs/1.PNG";
import Img2 from "../assets/bookingImgs/2.PNG";
import Img3 from "../assets/bookingImgs/3.PNG";
import Img4 from "../assets/bookingImgs/4.PNG";
import Img5 from "../assets/bookingImgs/5.PNG";
import Img6 from "../assets/bookingImgs/6.PNG";
import Img7 from "../assets/bookingImgs/7.PNG";
import Img8 from "../assets/bookingImgs/8.PNG";
      ...
      <div className="w-full h-full bg-[#0a192f] text-white pt-10">
        <div className="w-full h-[20vh] lg:h-[30vh] relative">
          <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2 lg:h-fit sm:pl-14 sm:pr-20 pr-5">
            ...
            <h3 className="pl-5 font-thin">React JS / CSS</h3>
          </div>
        </div>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 lg:h-full sm:pl-20 sm:pr-20 pr-5 pl-5 pb-20 pt-10 ">
          <div className="col-span-4">
            ...
            <p>Booking.com created with React JS & CSS.</p>
            <ul className="list-disc pl-10 py-5">
              <li className="pb-1 cursor-auto">
                Front-end copy of booking.com
              </li>
              <li className="pb-1 cursor-auto">
                This app incorporates the use of React Calendar.
              </li>
              <li className="pb-1 cursor-auto">
                Designed with React, HTML & CSS
              </li>
            </ul>
            <div className="py-5">
              <button className="text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#11d670]">
                <a
                  ...
                  href="https://github.com/conordocs/bookingcom_react"
                  target="_blank"
                  rel="noreferrer"
                >
                  View Code
